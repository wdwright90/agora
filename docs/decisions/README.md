...
Use the [ADR template](../templates/adr.md) for consequential choices and tradeoffs. Use filenames such as `0001-descriptive-choice.md` and stable IDs such as `ADR-001`.
