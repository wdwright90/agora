...
Store detailed specifications shared by multiple components here. Use the [spec template](../templates/spec.md) and identify every participating component and package.
